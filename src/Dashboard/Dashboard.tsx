...
const Dashboard: React.FC = () => {
  // const [activePage, setActivePage] = useState('dashboard'); // 'dashboard' or 'products'
  const [activePage, setActivePage] = useState('dashboardpage'); // 'dashboard' or 'products'
  ...
  const handleNavigation = (page: string) => {
    ...
    return (
    <div className="container panel-size">
      ...
      <div className="container-fluid">
        <div className="row">
              ...
              <div className="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                <ul className="nav flex-column">
                  <li className="nav-item">
                    <button className="nav-link d-flex align-items-center gap-2" onClick={() => handleNavigation('dashboardpage')}>
                      <svg className="bi">
                  ...
                  <li className="nav-item">
                    <button className="nav-link d-flex align-items-center gap-2" onClick={() => handleNavigation('orders')}>
                      <svg className="bi">
                  ...
                  <li className="nav-item">
                    <button className="nav-link d-flex align-items-center gap-2" onClick={() => handleNavigation('products')}>
                      <svg className="bi">
                        <use xlinkHref="#cart" />
                      </svg>
                      Products
                  ...
                  <li className="nav-item">
                    <button className="nav-link d-flex align-items-center gap-2" onClick={() => handleNavigation('customers')}>
                      <svg className="bi">
                  ...
                  <li className="nav-item">
                    <button className="nav-link d-flex align-items-center gap-2" onClick={() => handleNavigation('reports')}>
                      <svg className="bi">
          ...
          <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4" >
            {/* Renderiza la vista en función de la página activa */}
...
// import ColorModes from '../color-modes';
// import './dashboard.css';
// import Products from './Screens/Products'; // Importa el componente de Products
...
//                 <ul className="nav flex-column">
//                   <li className="nav-item">
//                     <button className="nav-link d-flex align-items-center gap-2" onClick={() => handleNavigation('dashboard')}>
//                       <svg className="bi">
//                         <use xlinkHref="#house-fill" />
//                       </svg>
//                       Dashboard
...
//             </div>
//             )}
//             {activePage === 'products' && <Products />} {/* Muestra el componente de Products si está activo */}
//           </main>
//         </div>
//       </div>
