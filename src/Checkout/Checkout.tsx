...
import './checkout.css'; // Ensure to create a CSS file for your styles
...
const Checkout: React.FC = () => {
    ...
    useEffect(() => {
      ...
      // Cleanup function para remover el evento al desmontar
      return () => {
        if (form) {
        ...
        <div className="container">
            ...
            <header data-bs-theme="dark">
                ...
                <div className="container-fluid">
                    ...
                    <Link className="btn btn-sm btn-outline-secondary ms-2" to="/checkout"><i className="bi bi-cart"></i> Cart</Link>
                    </div>
                </div>
                </nav>
            </header>
